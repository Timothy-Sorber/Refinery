...
3. Extend your main class with 'mod' and add an 'onEnable' method (Your IDE should use autocomplete), use the 'game' variable to interact with the game. (e.g. adding ground, objects or even UI!)
